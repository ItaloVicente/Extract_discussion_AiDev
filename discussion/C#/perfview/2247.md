...
**👤 brianrob** comentou em 2025-06-26T23:50:43Z:
...
- **📍 brianrob** em `src/PerfView/EventViewer/EventWindow.xaml.cs` (Linha/Pos 86):
...
- **📍 Copilot** em `src/PerfView/EventViewer/EventWindow.xaml.cs` (Linha/Pos 86):
