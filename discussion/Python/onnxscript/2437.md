...
**👤 codecov[bot]** comentou em 2025-07-03T20:29:02Z:
...
**👤 gramalingam** comentou em 2025-07-04T00:28:33Z:

@copilot , can you run "lintrunner -a" to handle the formatting issues reported?

**👤 Copilot** comentou em 2025-07-04T00:32:51Z:
...
## 🔍 PR Reviews (8) e Comentários de Linha (5)
...
- **📍 gramalingam** em `onnxscript/rewriter/basic_rules.py` (Linha/Pos 1):
...
- **📍 Copilot** em `onnxscript/rewriter/basic_rules.py` (Linha/Pos 1):
...
- **📍 gramalingam** em `onnxscript/rewriter/fuse_relus_clips_test.py` (Linha/Pos 1):
...
- **📍 Copilot** em `onnxscript/rewriter/fuse_relus_clips_test.py` (Linha/Pos 1):
...
- **📍 github-advanced-security[bot]** em `onnxscript/rewriter/ort_fusions/instance_to_group_normalization.py` (Linha/Pos 1):
  > ## Unused import
  > 
