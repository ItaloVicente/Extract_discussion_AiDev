...
**👤 cloudflare-workers-and-pages[bot]** comentou em 2025-05-24T07:06:56Z:
...
**👤 ellipsis-dev[bot]** comentou em 2025-05-24T07:22:37Z:
...
## 🔍 PR Reviews (6) e Comentários de Linha (7)
...
- **📍 ellipsis-dev[bot]** em `docs/guides/procedural-api.md` (Linha/Pos 76):
...
### 🛠️ Revisão por jxnl [Status: COMMENTED]
...
- **📍 jxnl** em `kura/types/summarisation.py` (Linha/Pos 1):
  > make this with xml
...
- **📍 jxnl** em `kura/v1/example.py` (Linha/Pos 1):
  > delete this file
...
- **📍 jxnl** em `tutorial_test/tutorial.py` (Linha/Pos 1):
  > delete this file
...
- **📍 ellipsis-dev[bot]** em `kura/explorer/backend/routers/clusters.py` (Linha/Pos 1):
...
- **📍 ellipsis-dev[bot]** em `kura/explorer/backend/run_integration_tests.sh` (Linha/Pos 1):
...
- **📍 ellipsis-dev[bot]** em `kura/kura.py` (Linha/Pos 45):
